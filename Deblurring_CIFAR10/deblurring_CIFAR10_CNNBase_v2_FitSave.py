...
from autoencoder_models import DeblurringCNNBase_v2
...
filename = "./reports/CNNBase_v2/" + "epochs" + str(EPOCHS) + ".obj"
filehandler = open(filename, 'wb')
list = extract_from_report(report, metrics)
dill.dump(list, filehandler)

model.save("./models/CNNBase_v2/" + "epochs" + str(EPOCHS))