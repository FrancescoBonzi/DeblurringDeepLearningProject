...
'''class DeblurringCNNBase_v2(tf.keras.Model):
    def __init__(self):
        ...
        self.conv10 = Conv2D(32, 3, activation='relu', padding='same')
        ...
        self.conv15 = Conv2D(64, 3, activation='relu', padding='same')
        ...
        self.deconv5 = Conv2DTranspose(64, 3, activation='relu', padding='same')
        ...
        self.deconv10 = Conv2DTranspose(32, 3, activation='relu', padding='same')
        ...
        self.deconv15 = Conv2DTranspose(16, 3, activation='relu', padding='same')
        self.output_layer = Conv2DTranspose(
            3, 3, activation='relu', padding='same')
'''
